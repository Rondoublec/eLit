...
/**
 * Controleur ge gestion des Ouvrages
 */
@Controller
public class OuvrageController {

    private static final Logger log = LoggerFactory.getLogger(OuvrageController.class);
     ...
     * @return
     */
    @GetMapping("/ouvrages/edit/{spotId}")
     ...
     * @return
     */
    @GetMapping("/ouvrages/secteur/{spotId}")
    public String detailSpot(@PathVariable("spotId") Long spotId, final RedirectAttributes redirectAttributes,
        ...
        if(monSpot != null) {
            ...
            if (user != null) {
                ...
                model.addAttribute("user", userNouveau);
            }
            model.addAttribute("membre", estPersonnel(user));
     ...
     * @return
     */
    @GetMapping("/ouvrages/addSecteur")
     ...
     * @return
     */
    @PostMapping(value = "/ouvrages/addSecteur")
     ...
     * @return
     */
    @PostMapping(value = "/ouvrages/deleteSecteur")
    ...
    /**
     * Enregistre le commentaire de l'user connecté
     ...
     * @return
     */
    @PostMapping(value = "/ouvrages/addComment")
    public String ajouterCommentaireSubmit(Model model, @Valid @ModelAttribute("commentaire") Commentaire commentaire,
        ...
        if (bindingResult.hasErrors()){
            ...
            /** Garder la liste des secteurs de l'user */
            majModel(model,spotId,httpSession);
    ...
    /**
     *      * Met à jour le commentaire par l'user connecté
     *      * pour le spot correspondant à spotId
     * @param model
     * @param commentaire
     * @param result
     ...
     * @return
     */
    @PostMapping(value = "/ouvrages/updateComment")
     ...
     * @return
     */
    @PostMapping(value = "/ouvrages/deleteComment")
    ...
    private boolean estPersonnel (User user) {
        boolean membre = false;
        if (user != null) {
            Set<Role> roles = user.getRoles();
            for (Role role : roles) {
                if (role.getRole().equals("PERSONNEL")) { membre = true; }
            }
        }
        return membre;
    }
