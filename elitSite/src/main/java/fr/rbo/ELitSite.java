...
public class ELitSite implements CommandLineRunner{

	private static final Logger log = LoggerFactory.getLogger(ELitSite.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(ELitSite.class, args);
	}
